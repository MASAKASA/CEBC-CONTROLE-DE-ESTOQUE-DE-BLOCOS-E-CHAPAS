Attribute VB_Name = "daoDestino"
Option Explicit

Private listaDestinos As Collection
Private destino As objDestino
' Cadastra e edita objeto
Function cadastrarEEditar(destino As objDestino)
    ...
    If cadastro = True Then ' Se cadastro
        ...
        strSql = "INSERT INTO Destinos ( Nome_Destino )VALUES ('" & destino.nome & "');"
        
        rs.Open strSql, CONEXAO_BD, adOpenKeyset, adLockPessimistic
    Else
        ' Se edição
        strSql = "UPDATE Destinos SET Nome_Destino = '" & destino.nome & "', " _
            & "' WHERE Id_Destino = '" & destino.id & "';"
...
Function pesquisarPorId(id As String) As objDestino
    ' String para consultas
...
Function pesquisarPorNome(nomeDestino As String) As objDestino
    ' String para consultas
    Dim rs As ADODB.Recordset
    Dim strSql As String
